...
class ApplicationControllerTest {
    ...
    void applyForJobs_Success() throws Exception {
        MockMultipartFile resume = new MockMultipartFile("resume", "resume.pdf", "application/pdf", "content".getBytes());
    ...
    void getUserApplications_Success() throws Exception {
        when(service.getUserApplications(anyLong(), anyString())).thenReturn(List.of(new ApplicationResponse()));
    ...
    void getJobApplications_Success() throws Exception {
        when(service.getJobApplications(anyLong(), anyString(), anyLong())).thenReturn(List.of(new JobApplicationResponse()));
